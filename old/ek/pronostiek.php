...
define('title','Mijn Pronostieken - EK pronostiek tornooi - Home Astrid');
...
<p style="font-size:160%;"><b>Welkom bij de Home Astrid-EK-Pronostiek!</b></p>
<p style="font-size:120%;">Meer uitleg over hoe het allemaal in zijn werk gaat, vind je op de <a href="uitleg.php">Speluitleg</a>-pagina. <br/><br/>
	Mochten er toch nog onduidelijkheden of prangende vragen zijn, stuur gerust een berichtje<br/> naar 
	<a href="https://www.facebook.com/eline.thielemans">Eline Thielemans</a> of <a href="http://facebook.com/pieterreuse">Pieter Reuse</a>. 
	Maar lees dus eerst de Speluitleg!</p><br/>
	Update 12/06: <ul>
	<li>prijzenpot is aardig bijgespekt</li>
	<li>via de rangschikking kun je enkel nog pronostieken zien waarvoor de deadline
	al verstreken is</li>
	<li>om deelnemers die later ingeschreven zijn nog een faire kans gegeven,<br/>
	is de deadline van de schiftingsvraag verschoven naar maandagavond</li>
	</ul>
...
<?php
	...
	if($i==0){ //nooit uitvoer gehad?
		echo "Er zijn geen komende matchen meer. Bedankt om mee te doen met de pronostiek van Home Astrid voor het EK van 2016!<br/>";
	} else {
		echo "</table>\r\n<br/>\r\n"; 
