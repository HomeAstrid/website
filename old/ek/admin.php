	...
	if(!preg_match('/^[0-9a-zA-Z]{2,32}$/', $username)){
		...
		if($ww1 !== $ww2){
			...
			if($ww1===""){
				...
				$query = "INSERT INTO `wk_user` (`username`,`password`,`email`,`usemail`,`admin`,`score`) VALUES (".
...
<p> Aanpassingen in komende matchen enkel mogelijk via <a href="//astrid.ugent.be/ek/db/">phpmyadmin</a> (astrid:LYQHT76p4be6kRbA3nwB).</p><br/>
<br/><br/>
