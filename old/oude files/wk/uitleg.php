...
?>
					...
					<article>
						...
						<h3>Deadline</h3>
						<p>Om ervoor te zorgen dat info van <strong>net</strong> voor de aftrap geen invloed heeft, is de deadline voor elke pronistiek een half uur <?php echo utf8_encode("vóór");?> de aftrap van de match gelegd. Er is hier <?php echo utf8_encode("één");?> uitzondering op: de match Ivoorkust - Japan in groep C op 15 juni.</p>
						<p>Omdat de aftrap van deze match om 03u 's nachts Belgische tijd gegeven wordt, om de deadline van deze match mee te geven met de mailing van 13 of 14 juni <?php echo utf8_encode("én");?>  omdat we jullie er niet toe willen aanzetten om zo laat op te blijven, is deze deadline op 14 juni om 23u59 gelegd. </p>
						...
						<p><strong>Je kunt je pronostiek wel blijven aanpassen</strong> tot aan de deadline, dus bij twijfel kun je het blijven aanpassen.</p>

						<h3>Tijd Match</h3>
						<p>In deze kolom staat het moment waarop de aftrap van deze match wordt gegeven <strong>in Belgische tijd</strong>. Hierbij is 16/06 00:00 het begin van 16 juni (dus <?php echo utf8_encode("één");?> minuut na 15/06 23:59).</p>

						<h3>Ploegen</h3>
						<p>Welke ploegen de match spelen.</p>
						<p>Hierbij is vanaf match 49 (de winnaar van groep A tegen de tweede van groep B, op 28 juni om 18u Belgische tijd) in het begin van het tornooi niet gekend welke ploegen deze match zullen spelen. Van zodra deze ploegen bekend zijn, zal de beheerder de ploegen van deze matchen aanpassen. Dit is ruimschoots <?php echo utf8_encode("vóór");?> het verstrijken van de deadline, dus je kunt je pronostiek er nog aan aanpassen.</p>
						...
						<p>Goed voorspeld maar toch 0 punten? Vraag <a href="//pieterreuse.be/fb">de beheerder</a> de scores opnieuw te berekenen, hij heeft misschien een knopje te weinig of te veel ingedrukt. Maar de server is erop voorzien alle scores te herberekenen met de ingevulde uitslagen door <?php echo utf8_encode("één");?> druk op de knop, dus veel moeite is dat niet voor de beheerder ;-)</p>
						...
						<p>Score foutief berekend denk je? Stuur een berichtje naar <a href="//pieterreuse.be/fb">de beheerder</a>!</p>

						<h3>Ex aequo</h3>
						<p>Ex aequos worden opgelost met de schiftingsvraag (het aantal doelpunten over heel het WK; excl penalties na verlengingen, moet ingevuld zijn voor de openingsmatch).</p>
						...
						<p><ul><li>1e plaats: &euro;40</li>
							<li>2e plaats: &euro;25</li>
							<li>3e plaats: &euro;20</li>
							<li>4e plaats: &euro;10</li>
							<li>5e plaats: &euro;5</li></ul>
						...
						<p><strong>Overtuigd om mee te spelen voor de prijzen?</strong> Betalen kan bij <a href="//pieterreuse.be/fb">Pieter</a> op kamer 515 
						of <a href="https://www.facebook.com/jasper.juchem">Jasper</a> in kamer 133. Vermeld hierbij zeker je gebruikersnaam.</p>
						...
						<p>Deze wedstrijdjury bestaat uit onze praeses Jasper en onze ICT Pieter.</p>
						
						<h2>Verder vragen?</h2>
						<p>Voor verdere onduidelijkheden mag je steeds aankloppen bij iemand van het praesidium, kamer 515, of een berichtje sturen <a href="//pieterreuse.be/fb">hier</a>.</p>
					</article>
<?
include('footer.php');
