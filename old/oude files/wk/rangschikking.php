...
<?php
	...
	if(mysql_num_rows($result_user_descA)>=1) mysql_data_seek($result_user_descA,0);
?>
</table>
<br/> 
<?php if($betaald==0){
...
<p style="font-size:80%;"><b>Foutje? Vraag <a href="https://facebook.com/pieterreuse" target="_blank">de beheerder</a></b> de scores opnieuw te berekenen.<br/>
