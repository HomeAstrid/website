...
define('title','WK pronostiek tornooi - Home Astrid');
...
?>
		...
		<div class="column left-column">
			<p>Dit is het WK 2018 pronostiek tornooi van Home Astrid.</p>
			<p>Inloggen kun je hiernaast.</p>
			<p>Indien je nog geen login hebt, maar er eentje wil, contacteer dan <a href="//facebook.com/ronald.merckx">Ronald</a>.</p>
